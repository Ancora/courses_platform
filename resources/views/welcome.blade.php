<x-app-layout>
    <div class="grid lg:flex bg-fixed pt-20">
        <div class="lg:w-3/4">
            <section class="bg-cover rounded-md mx-4" style="background-image: url({{asset('img/home/bg-home.png')}})">
            ...
            <section class="mt-24">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-8">
                    <article>
                        <figure>
                            <img class="rounded-xl h-48 w-full" src="{{asset('img/home/blog.png')}}" alt="Blog">
                        </figure>
                        <header class="mt-2">
                    ...
                    <article>
                        <figure>
                            <img class="rounded-xl h-48 w-full object-cover" src="{{asset('img/home/artigos.png')}}" alt="Artigos">
                        </figure>
                        <header class="mt-2">
                    ...
                    <article>
                        <figure>
                            <img class="rounded-xl h-48 w-full object-cover" src="{{asset('img/home/fale-conosco.png')}}" alt="Cursos">
                        </figure>
                        <header class="mt-2">
